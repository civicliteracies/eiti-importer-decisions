...
**Technical detail:** Flag defined at `packages/core/src/core/settings.py:Settings.accept_legacy_archive_imports`. Cleaner rule at `packages/cleaner/src/cleaner/rules.py:ArchiveMintAnonymousEntityRule`. Sentinel aliases at `packages/enricher/src/enricher/resources/entity-aliases.toml` (entries with `eiti_id = "eiti_id_company:00000000-0000-0000-0000-000000000000"` etc.). Emission code is `CleaningCode.ANONYMOUS_PLACEHOLDER_FILL`. All transitional code in this scope carries the `# LEGACY_ARCHIVE_UPLOAD` marker for grep-driven cleanup.
